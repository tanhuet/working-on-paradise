           ...
           {user?.role ==="JobSeeker" || !user ? 
            ...
            {user ? (
              <ul className={`navbar-nav ${classes.auth}`}>
                ...
                <li className="nav-item">
                <NavLink className={`nav-link ${classes['btn-logout']} ${classes['username']}`} href="#" onClick={displayHandler}>{user.name}</NavLink>
                {isDisplayAccount && 
                  <div className={classes.test} ref={accountRef}>
                    <NavLink to="/account">
                      <div className={classes.logout}>
                        ...
                        <div>
                          <NavLink className="nav-link" href="#" to="/account" onClick={() => {setIsDisplayAccount(false)}}>Account</NavLink>
                        </div>
                      </div>
                    </NavLink>
                    <NavLink to="/signin" onClick={handleLogout}>
                      <div className={classes.logout}>
                        <div>
                          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="black" class="bi bi-door-closed-fill" viewBox="0 0 16 16">
