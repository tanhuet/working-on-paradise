      ...
      >
        ...
        <div className={classes.data} style={{ height: "293px" }}>
          <div className={classes.containercv}>
            <button className={`${classes.share} ${classes.style4}`}>
              Share
            </button>
            <button className={`${classes.download} ${classes.style4}`}>
              Download
            </button>
          </div>
        </div>
